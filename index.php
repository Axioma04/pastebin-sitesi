...
<body>
    ...
    <h1>Pastebin</h1><p class="text-right"><input type="submit" value="Kodu kaydet" class="btn btn-primary"></p>
    <?php
    if($_POST){
        if( empty($_POST["kod"]) ){
            ...
            echo "<a href='/code.php?id=".$_data['id']."'>Koda bakmak için tıkla!</a>";
        }
    }
    ?>
